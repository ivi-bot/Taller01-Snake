...
public class SnakeModel extends GameModel {
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(Color.decode("#927a70"));

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(Color.decode("#1c0d02"));
